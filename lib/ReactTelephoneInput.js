...
var ReactTelephoneInput = exports.ReactTelephoneInput = React.createClass({
    ...
    }, _defineProperty(_propTypes, 'className', React.PropTypes.string), _defineProperty(_propTypes, 'inputId', React.PropTypes.string), _defineProperty(_propTypes, 'onChange', React.PropTypes.func), _defineProperty(_propTypes, 'onEnterKeyPress', React.PropTypes.func), _defineProperty(_propTypes, 'onBlur', React.PropTypes.func), _defineProperty(_propTypes, 'onFocus', React.PropTypes.func), _defineProperty(_propTypes, 'disabled', React.PropTypes.bool), _defineProperty(_propTypes, 'pattern', React.PropTypes.string), _defineProperty(_propTypes, 'required', React.PropTypes.bool), _propTypes),
