...
var ReactTelephoneInput = exports.ReactTelephoneInput = React.createClass({
    ...
    propTypes: (_propTypes = {
        ...
        countryPreferredClassName: PropTypes.string,
        countryActiveClassName: PropTypes.string,
        countryHighlightClassName: PropTypes.string,
        dropDownClassName: PropTypes.string,
        dropDownShownClassName: PropTypes.string,
        arrowClassName: PropTypes.string,
        arrowDroppedClassName: PropTypes.string,
        inputClassName: PropTypes.string,
        inputInvalidClassName: PropTypes.string,
        flagClassName: PropTypes.string,
        flagViewClassName: PropTypes.string,
        flagViewSelectedClassName: PropTypes.string,
        flagViewShownClassName: PropTypes.string,
    ...
    }, _defineProperty(_propTypes, 'className', PropTypes.string), _defineProperty(_propTypes, 'inputId', PropTypes.string), _defineProperty(_propTypes, 'onChange', PropTypes.func), _defineProperty(_propTypes, 'onEnterKeyPress', PropTypes.func), _defineProperty(_propTypes, 'onBlur', PropTypes.func), _defineProperty(_propTypes, 'onFocus', PropTypes.func), _defineProperty(_propTypes, 'disabled', PropTypes.bool), _defineProperty(_propTypes, 'pattern', PropTypes.string), _defineProperty(_propTypes, 'required', PropTypes.bool), _propTypes),
    ...
    getCountryDropDownList: function getCountryDropDownList() {
        ...
        var countryDropDownList = map(this.state.preferredCountries.concat(this.props.onlyCountries), function (country, index) {
            ...
            var itemClasses = classNames((_classNames = {}, _defineProperty(_classNames, self.props.countryClassName, true), _defineProperty(_classNames, self.props.countryPreferredClassName, findIndex(self.state.preferredCountries, { iso2: country.iso2 }) >= 0), _defineProperty(_classNames, self.props.countryHighlightClassName, self.state.highlightCountryIndex === index), _classNames));
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        this.props.showDropDownOnClick ? React.createElement('div', { className: arrowClasses }) : null
                    )
                ),
